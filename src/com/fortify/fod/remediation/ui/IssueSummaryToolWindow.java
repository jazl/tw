...
public class IssueSummaryToolWindow extends RemediationToolWindowBase {
    ...
    private JPanel createRecommendationsContent(){
        JPanel panel = new JPanel(new BorderLayout());
        panel.add(new JBScrollPane(recommendationsLabel), BorderLayout.CENTER);
        return panel;
    }
    ...
    protected void onIssueChange(IssueChangeInfo changeInfo) {
        ...
        detailsLabel.setText(mockAuditDetails);
        recommendationsLabel.setText(mockRecommendations);
    }
    ...
    public void init(ToolWindow window) {
        ...
        detailsLabel = new JBLabel();
        recommendationsLabel = new JBLabel();
    }
}
