...
public class HtmlLabelTests extends JFrame {
    ...
    public static void main(String[] args) throws Exception {
        HtmlLabelTests jTextPaneApp = new HtmlLabelTests();
        jTextPaneApp.setVisible(true);
//        Thread.currentThread().sleep(1000);
//        jTextPaneApp.change();
    }

    public HtmlLabelTests() {
        setSize(400, 400);
        ...
        try {
            ...
            JLabel linkLabel = new JLabel("<html><body><a>www.msn.com</a></body></html>");
