...
public class LoadSync {
    ...
    public static void main(String args[]) {
        ...
        editorPane.addHyperlinkListener(new HyperlinkListener() {
            ...
            public void hyperlinkUpdate(HyperlinkEvent e) {
                System.out.println("HyperlinkEvent! e.getURL() = "+e.getURL());
            }
        });
    ...
    public static void doLoadCommand(JTextComponent textComponent, String filename) {
        ...
        try {
            ...
            htmlDoc.setInnerHTML(htmlElement, mockRecommendations);
